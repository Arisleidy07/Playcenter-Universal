...
function TarjetaProducto({ producto }) {
  ...
  return (
    <div onClick={irADetalle} className="card cursor-pointer" title={producto.nombre}>
      <img
        src={producto.imagen}
        alt={producto.nombre}
        className="w-40 h-40 object-contain rounded-lg shadow p-1 bg-white"
      />
      <div className="flex flex-col flex-grow ml-6">
        <h2 className="font-semibold text-lg mb-1 text-[#1e293b]">{producto.nombre}</h2>
