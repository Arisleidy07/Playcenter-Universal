...
const CategoryManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingCategory) {
        await updateDoc(
          doc(db, "categorias", editingCategory.id),
          categoryData
        );
      } else {
            ...
            <>
              <button
                onClick={async () => {
                  if (
                    confirm(
                      `¿Verificar y limpiar ${phantomCategoryIds.length} categorías fantasma?\n\nEsto verificará si alguna volvió a existir en Firebase.`
                    )
                  ) {
              ...
              <button
                onClick={() => {
                  if (
                    confirm(
                      `¿Limpiar TODAS las ${phantomCategoryIds.length} categorías fantasma?\n\n⚠️ Esto las eliminará sin verificar si existen en Firebase.`
                    )
                  ) {
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-500">
                        ...
                        <span>
                          Creada: {formatDate(category.fechaCreacion)}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() =>
                          toggleCategoryStatus(category.id, category.activa)
                        }
          ...
          >
            ...
            >
              <div className="p-4">
                ...
                >
                  <span className="fs-2 fw-bold">⚠️</span>
                </div>
                ...
                >
                  ...
                  {categoryToDelete?.nombre}"? Esta acción no se puede deshacer
                  y puede afectar los productos asociados.
                </p>
