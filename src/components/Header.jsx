        ...
        <div className="flex items-center justify-between w-full gap-3">
          ...
          <div className="hidden xl:flex w-full items-center justify-between gap-6">
            ...
            >
              ...
              >
                <span className="flex items-center gap-1 text-[11px] text-gray-500 dark:text-gray-300">
                  <FaMapMarkerAlt className="text-[#4FC3F7]" />
                  Método de entrega
                </span>
                <strong
                  className="block text-[12px] font-semibold text-gray-700 dark:text-white tracking-wide truncate max-w-[120px] sm:max-w-[160px] md:max-w-[200px] lg:max-w-[220px]"
            ...
            <div className="flex items-center gap-6 text-sm font-medium text-gray-700 dark:text-white">
              <Link to="/" className="nav-link text-gray-700 dark:text-white hover:text-[#4FC3F7] dark:hover:text-[#60a5fa] transition">
                Inicio
              </Link>
              <Link
                to="/categorias"
                className="nav-link text-gray-700 dark:text-white hover:text-[#4FC3F7] dark:hover:text-[#60a5fa] transition"
              >
                Categorías
              </Link>
              <Link
              ...
              <Link
                to="/carrito"
                className="nav-link text-xl hover:scale-110 transition"
              >
                🛒
              </Link>
              {(usuarioInfo?.isAdmin ||
              ...
              {usuario ? (
                <motion.div className="relative" whileTap={{ scale: 0.95 }}>
                  <Link to="/profile">
                    <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-[#4FC3F7] shadow hover:shadow-lg transition cursor-pointer bg-white dark:bg-gray-700">
                      {usuario.photoURL ? (
                        <img
