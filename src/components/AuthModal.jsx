...
export default function AuthModal({ isOpen, onClose, onLogin }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Aquí pones validación real o API call si quieres
    onLogin();
    onClose();
  };
        ...
        {isLogin ? (
          <>
            ...
            <p className="sign-up-label">
              ...
              <span className="sign-up-link" onClick={() => setIsLogin(false)}>Sign up</span>
            </p>
          </>
        ) : (
          <>
            ...
            <p className="sign-up-label">
              ...
              <span className="sign-up-link" onClick={() => setIsLogin(true)}>Log in</span>
            </p>
          </>
        )}
