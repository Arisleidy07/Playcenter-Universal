      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute left-0 right-0 bottom-0 bg-white rounded-t-2xl shadow-2xl p-6 md:hidden max-h-[85vh] overflow-y-auto z-20"
          ...
          <div
            className="hidden md:flex items-center justify-center h-full z-20"
            onClick={(e) => e.stopPropagation()}
          >
            <motion.div
