...
function SidebarCategorias() {
  ...
  return (
    <aside className="w-[145px] sm:w-44 md:w-52 flex-shrink-0 bg-white border-r border-gray-200 shadow-md px-2 py-4 sticky top-20 h-[calc(100vh-5rem)] overflow-y-auto z-30">
      <h2 className="text-xs sm:text-sm md:text-base font-bold text-blue-800 mb-4 text-center sm:text-left uppercase tracking-wide select-none">
        Categorías
      </h2>
