...
function HogarInteligente() {
    const productos = [
        {
            id: 1,
            nombre: "Enchufe Wi-Fi Inteligente",
            imagen: "/products/enchufe-inteligente.png",
            precio: "$24.99",
        },
        {
            id: 2,
            nombre: "Bombillo LED Smart RGB",
            imagen: "/products/bombillo-smart.png",
            precio: "$19.99",
        },
        {
            id: 3,
            nombre: "Cámara de Seguridad Inteligente",
            imagen: "/products/camara-smart.png",
            precio: "$89.99",
        },
    ];
    ...
    return (
        <div className="p-6 pt-28">
            <h1 className="text-3xl font-bold mb-6 text-purple-700">Hogar Inteligente</h1>
