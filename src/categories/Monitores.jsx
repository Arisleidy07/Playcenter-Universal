...
function Monitores() {
    const productos = [
        {
            ...
            imagen: "/products/monitor-lg.png",
            precio: "$199.99",
        },
        {
            id: 2,
            nombre: "Monitor Samsung Curvo 27''",
            imagen: "/products/monitor-samsung.png",
            precio: "$249.99",
        },
        {
            id: 3,
            nombre: "Monitor ASUS Gaming 24''",
            imagen: "/products/monitor-asus.png",
            precio: "$179.99",
        },
    ];
    ...
    return (
        <div className="p-6 pt-28">
            <h1 className="text-3xl font-bold mb-6 text-purple-700">Monitores</h1>
