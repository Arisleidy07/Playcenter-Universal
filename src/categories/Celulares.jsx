...
function Celulares() {
    const productos = [
        {
            ...
            imagen: "/products/iphone-14.png",
            precio: "$1,099.99",
        },
        {
            id: 2,
            nombre: "Samsung Galaxy S23 Ultra",
            imagen: "/products/galaxy-s23.png",
            precio: "$999.99",
        },
        {
            id: 3,
            nombre: "Xiaomi Redmi Note 12",
            imagen: "/products/redmi-note-12.png",
            precio: "$299.99",
        },
    ];
    ...
    return (
        <div className="p-6 pt-28">
            <h1 className="text-3xl font-bold mb-6 text-purple-700">Celulares</h1>
