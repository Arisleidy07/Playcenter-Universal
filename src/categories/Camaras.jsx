...
function Cámaras() {
    const productos = [
        {
            ...
            imagen: "/products/camera1.png",
            precio: "$399.99",
        },
        {
            id: 2,
            nombre: "Cámara de Seguridad WiFi",
            imagen: "/products/securitycam.png",
            precio: "$89.99",
        },
        {
            id: 3,
            nombre: "Cámara Deportiva Sumergible",
            imagen: "/products/actioncam.png",
            precio: "$119.99",
        },
    ];
    ...
    return (
        <div className="p-6 pt-28">
            <h1 className="text-3xl font-bold mb-6 text-purple-700">Cámaras</h1>
