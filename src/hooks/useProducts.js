...
export const useProducts = (includeInactive = false) => {
  ...
  // Escuchar evento de producto guardado y forzar actualización inmediata
  useEffect(() => {
...
export const useProductsByCategory = (categoryId) => {
  ...
  // Escuchar cambios en localStorage y evento de producto guardado
  useEffect(() => {
      ...
      try {
        ...
        const unsubscribe = onSnapshot(
          ...
          (snapshot) => {
            ...
            // Ordenar por fecha de creación en el cliente (si no está en query)
            const sortedProducts = categoryId && categoryId !== "todos" 
