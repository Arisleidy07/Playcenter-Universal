    ...
    return (
        <div
        className="min-h-screen bg-gradient-to-b from-white via-cyan-50 to-white text-gray-900 font-sans px-4 sm:px-6 pt-8 sm:pt-12 pb-16 sm:pb-24 flex flex-col items-center"
        style={{ scrollBehavior: "smooth" }}
        >
        {/* Título con parallax y sombra suave */}
        <h1
            className="text-5xl sm:text-7xl font-extrabold mb-4 tracking-wide text-center text-blue-700 drop-shadow-[0_10px_20px_rgba(0,112,255,0.25)]"
            style={{
        ...
        <h2
            className="text-2xl sm:text-4xl font-semibold mb-10 sm:mb-14 text-center text-cyan-600"
            style={{
        ...
        {/* Contenedor de info */}
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl p-8 sm:p-12 md:p-16 mb-12 sm:mb-16 border border-cyan-200">
        ...
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-12 w-full max-w-4xl justify-center items-center">
            <WhatsAppButton
    ...
    <div className="flex items-start gap-4 sm:gap-5">
        <div className={`text-2xl sm:text-3xl mt-1 ${color} drop-shadow-md transition-transform duration-300 hover:scale-110`}>
        {icon}
        </div>
        <div>
    ...
    <a
        ...
        className={`flex items-center justify-center gap-3 sm:gap-4 px-8 sm:px-12 py-4 sm:py-5 text-lg sm:text-2xl font-extrabold rounded-3xl shadow-lg text-white transition-transform duration-300 hover:scale-110 bg-gradient-to-r ${colors.join(" ")}`}
    >
        <FaWhatsapp className="text-2xl sm:text-3xl drop-shadow-md animate-pulse" />
        {text}
    </a>
    );
